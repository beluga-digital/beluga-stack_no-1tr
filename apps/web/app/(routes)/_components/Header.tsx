...
const Header: React.FC = () => {
  return (
    <Container
      align="center"
      as="header"
      className="sticky top-0 z-header bg-white/80 border-b border-slate-200 dark:bg-slate-950/80 dark:border-slate-800 backdrop-blur-md"
      spacing="xs"
    >
      <ContainerContent className="flex justify-between items-center">
        <svg
          ...
          viewBox="0 0 1274 314"
          width="100%"
        >
          <g transform="matrix(1,0,0,1,0,-1671.32)">
            <g id="logo_classic" transform="matrix(1.2737,0,0,0.314,0,1671.32)">
              <clipPath id="_clip1">
                <rect height="1000" width="1000" x="0" y="0" />
              </clipPath>
              <g clipPath="url(#_clip1)">
                <g transform="matrix(0.479652,0,0,1.94564,-111.355,-428.025)">
                  <g transform="matrix(1.04308,0,0,1.04308,-22.8651,-54.3311)">
                    <circle
                      cx="507.5"
                      cy="483.5"
                      r="220.5"
          ...
          <defs>
            <linearGradient
              gradientTransform="matrix(1.66717e-14,-272.27,272.27,1.66717e-14,507.5,704)"
            ...
            >
              <stop
                offset="0"
                style={{ stopColor: "rgb(0,59,220)", stopOpacity: 1 }}
              />
              <stop
                offset="1"
                style={{ stopColor: "rgb(107,139,255)", stopOpacity: 1 }}
              />
            </linearGradient>
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="matrix(244.182,-92,93.8025,248.967,1560,427)"
              gradientUnits="userSpaceOnUse"
              id="_Radial3"
              r="1"
            >
              ...
              <stop
                offset="0.57"
                style={{ stopColor: "rgb(217,220,255)", stopOpacity: 1 }}
              />
              <stop
                offset="1"
                style={{ stopColor: "rgb(201,205,255)", stopOpacity: 1 }}
              />
            </radialGradient>
            <linearGradient
              gradientTransform="matrix(-32.3095,-44.623,44.623,-32.3095,1465.37,400.97)"
              gradientUnits="userSpaceOnUse"
              id="_Linear4"
              x1="0"
              x2="1"
            ...
            >
              <stop
                offset="0"
                style={{ stopColor: "rgb(229,231,255)", stopOpacity: 1 }}
              />
            ...
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="matrix(-149.34,-39.8557,39.8557,-149.34,1869,436)"
              gradientUnits="userSpaceOnUse"
              id="_Radial5"
              r="1"
            >
              <stop
                offset="0"
                style={{ stopColor: "rgb(143,159,206)", stopOpacity: 1 }}
              />
              <stop
                offset="0.54"
                style={{ stopColor: "rgb(156,171,217)", stopOpacity: 1 }}
              />
              <stop
                offset="1"
                style={{ stopColor: "rgb(201,211,254)", stopOpacity: 1 }}
              />
            </radialGradient>
            <linearGradient
              gradientTransform="matrix(62.0546,-137.195,137.195,62.0546,1798,742)"
              gradientUnits="userSpaceOnUse"
              id="_Linear6"
              x1="0"
              x2="1"
            ...
            >
              ...
              <stop
                offset="0.57"
                style={{ stopColor: "rgb(207,218,255)", stopOpacity: 1 }}
              />
              <stop
                offset="1"
                style={{ stopColor: "rgb(186,201,255)", stopOpacity: 1 }}
              />
            </linearGradient>
            <linearGradient
              gradientTransform="matrix(62.3082,-74.8047,74.8047,62.3082,1780.69,715.805)"
              gradientUnits="userSpaceOnUse"
              id="_Linear7"
              x1="0"
              x2="1"
            ...
            >
              <stop
                offset="0"
                style={{ stopColor: "rgb(189,204,226)", stopOpacity: 1 }}
              />
              <stop
                offset="1"
                style={{ stopColor: "rgb(186,201,255)", stopOpacity: 1 }}
            ...
            <linearGradient
              gradientTransform="matrix(164.859,37.8839,-37.8839,164.859,1678.14,560.365)"
              gradientUnits="userSpaceOnUse"
              id="_Linear8"
              x1="0"
              x2="1"
            ...
            >
              <stop
                offset="0"
                style={{ stopColor: "rgb(169,191,227)", stopOpacity: 1 }}
              />
              <stop
                offset="0.52"
                style={{ stopColor: "rgb(168,188,228)", stopOpacity: 1 }}
              />
              <stop
                offset="1"
                style={{ stopColor: "rgb(164,178,233)", stopOpacity: 1 }}
              />
            </linearGradient>
            <linearGradient
              gradientTransform="matrix(-2.15189,-25.9036,25.9036,-2.15189,1569.58,460.998)"
              gradientUnits="userSpaceOnUse"
              id="_Linear9"
              x1="0"
              x2="1"
            ...
            >
              <stop
                offset="0"
                style={{ stopColor: "rgb(98,112,142)", stopOpacity: 1 }}
              />
              <stop
                offset="1"
                style={{ stopColor: "rgb(173,185,218)", stopOpacity: 1 }}
              />
            </linearGradient>
          </defs>
        </svg>
