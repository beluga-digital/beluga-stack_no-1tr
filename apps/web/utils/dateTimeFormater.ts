...
export const dateTimeFormater = (props: { value?: string | null | Date, format?: string, lang?: string, preffix?: string, suffix?: string }) => {
	...
	return ((props.preffix ? props.preffix : '') + formatedDate + (props.suffix ? props.suffix : ''))
}
